...
loss_mse_train = helpers.pickle_load('cnn_conv_train_mse_loss.pkl')
loss_mse_test = helpers.pickle_load('cnn_conv_test_mse_loss.pkl')
...
loss_l1_train = helpers.pickle_load('cnn_conv_train_l1_loss.pkl')
loss_l1_test = helpers.pickle_load('cnn_conv_test_l1_loss.pkl')
...
pred_conv = np.array(helpers.pickle_load('cnn_conv_pred_test.pkl'))
plt.figure()
...
pred_conv = np.array(helpers.pickle_load('cnn_conv_pred_train.pkl'))
plt.figure()
